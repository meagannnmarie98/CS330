...
namespace
{
    const char* const WINDOW_TITLE = "Meagan H lighting complex objects";
...
glm::vec3 gObjectColor(255.0f, 255.0f, 0.0f);
...
int main(int argc, char* argv[])
{
    ...
    // Load texture
    const char* texFilename = "../../resources/textures/swing.png";
...
void URender()
{
    ...
    const float angularVelocity = glm::radians(50.0f);
    if (gIsLampOrbiting)
    {
